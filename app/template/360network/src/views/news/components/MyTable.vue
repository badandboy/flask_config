<template>
  <div>
    <el-table :data="dataSource" style="width: 100%">
      ...
      <el-table-column prop="news_name" label="标题" width="180" />

      <el-table-column prop="cover" label="封面">
        <template slot-scope="scoped">
          <img style="width: 300px;height: 80px;" :src="scoped.row.news_cover_url">
        </template>
      </el-table-column>
      <el-table-column prop="content" label="内容">
        <template slot-scope="scoped">
          <img style="width: 220px;height: 220px; " :src="scoped.row.news_content_url">
        </template>
      </el-table-column>
